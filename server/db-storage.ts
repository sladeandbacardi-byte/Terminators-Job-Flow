...
export class DbStorage implements IStorage {
  ...
  async getFleetDashboardData(workerId?: string): Promise<any> {
    ...
    const workerAliases = workerId ? equivalentWorkerIds(workerId) : [];
    const myAssignment = workerId ? allAssignments.find(a => workerAliases.includes(a.workerId) && a.isActive) : null;
