...
type Overview = {
  ...
  inspections: Array<{ id: string; inspectionDate: string; overallResult: string; comments?: string | null; photoUrl?: string | null }>;
