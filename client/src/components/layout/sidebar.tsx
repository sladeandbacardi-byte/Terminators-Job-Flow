...
const ALL_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Daily Diaries",             href: "/field-diaries",     icon: BookOpen,      roles: ["admin", "manager", "coordinator", "service"] },
       { name: "Treatment Reports",         href: "/treatment-reports", icon: ClipboardCheck, roles: ["admin", "manager", "coordinator"] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "My Time",            href: "/my-overtime",        icon: Clock,          roles: ["admin", "manager", "coordinator", "accounts", "service", "sales"] },
      { name: "Time & Overtime",    href: "/overtime-approval",  icon: CheckSquare,    roles: ["admin", "manager"] },
    ],
  },
  {
    key: "admin",
    ...
    items: [
      ...
      { name: "Pricing Library",  href: "/pricing-library", icon: Tag,         roles: ["admin", "manager"] },
       { name: "Pest Product Library", href: "/treatment-reports", icon: ClipboardCheck, roles: ["admin", "manager"] },
