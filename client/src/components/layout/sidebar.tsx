  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          { name: "Fleet Guard",        href: "/fleet",             icon: Truck,       roles: ["admin", "manager", "coordinator", "service"] },
          { name: "Vehicles",           href: "/fleet/vehicles",    icon: Truck,       roles: ["admin", "manager", "coordinator", "service"] },
          { name: "Maintenance",        href: "/fleet/maintenance", icon: Wrench,      roles: ["admin", "manager", "coordinator", "service"] },
          { name: "Reported Issues",    href: "/fleet/report-issue", icon: AlertCircle, roles: ["admin", "manager", "coordinator", "service"] },
        ],
      },
      {
        type: "group",
